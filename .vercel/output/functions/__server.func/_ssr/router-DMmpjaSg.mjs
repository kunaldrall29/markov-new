...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DMmpjaSg.js
...
var styles_default = "/assets/styles-CKVlblsK.css";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{ title: "Markov — After-hours isolated perps on NVDAx and TSLAx" },
			{
				name: "description",
				content: "Isolated perpetual markets on the onchain mark of NVDAx and TSLAx. Two-sided RFQ. Max 3x. After hours is the session."
			},
			{
				name: "theme-color",
				content: "#0a0a0b"
...
var $$splitComponentImporter = () => import("./routes-CFaatsrp.mjs");
